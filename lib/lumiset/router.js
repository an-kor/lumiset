        ...
        for (let i = 0; i < pathSegments.length; i++) {
            ...
            if (pathSegment === '*') {
                if (i === pathSegments.length - 1) {
                    return true; // Match any remaining route segments
                }
                continue; // Match the current segment and move to the next
            }
            ...
            // If the current route segment does not match the current path segment, return false
